...
const cartItemsContainner = document.getElementById ("cart-items")
...
function updateCartModal() {
    ...
    cart.forEach(item => {
        ...
        cartItemsContainner.appendChild(cartItemElement)
    })
   ...
   cartItemsContainner.addEventListener("click", function (event){
